$.getScript("js/generalMethod.js", function () {
  ...
  myFun = (element) => {
    ...
    if (id == "myChart0")
      bubbleChartDiffBubble(url0, id, parentId, chartType0, element.value);

    if (id == "myChart1")
      areaChartNotTension(url1, id, parentId, chartType1, element.value);

    if (id == "myChart2")
      radarChart(url2, id, parentId, chartType2, element.value);

    if (id == "myChart3")
      hBarChartWithColor(url3, id, parentId, chartType3, element.value);
  };
